...
from src import params, vehicle as vehicle_module, distance_sensor as distance_sensor_module, led as led_module, switch as switch_module
...
brain = brain_module.Brain(
    brain_config, distance_sensors, leds, switches, vehicle)
